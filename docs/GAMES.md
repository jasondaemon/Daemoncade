...
| --- | --- | --- | --- | --- |
| <img src="../games/neon-breaker/icon.png" width="48" height="48" alt=""> | [Neon Breaker](../games/neon-breaker/) | `1.0.0` | Yes | Break luminous formations, chain combos, and bend each run with modern power-ups in a kinetic brick-breaking tribute. |
